...
class YangConfigParser : public CommonConfigBase, public IYangConfigParser {
 public:
  ...
  virtual void getVarient(std::string& variant);
 ...
 private:
  ...
  bool findElementNoAttributes(
      tinyxml2::XMLElement* node,
      std::string elementType,
      std::string& elementName);
  bool findElementWithAttributes(
      tinyxml2::XMLElement* node,
      std::string elementType,
      std::string& elementName,
      std::string& elementValue);
  bool findElementAndExtract(
      tinyxml2::XMLElement* node,
  ...
  std::shared_ptr<IYangConfig> mConfig; //!> The pointer to the
                                        //! config
  ...
  std::string mYangVersion; //!> Overall yang version XML config
                            //! was generated from using the
                            //! models
  ...
  struct ExtractElements : public Loggable {
    ...
    typedef bool (ExtractElements::*extractMethod)(
        tinyxml2::XMLElement*, std::shared_ptr<IYangElement>);
    ...
    bool extractChoice(
        tinyxml2::XMLElement* node,
        std::shared_ptr<IYangElement> parentElement);
    bool extractListEntry(
        tinyxml2::XMLElement* node,
        std::shared_ptr<IYangElement> parentElement);
    bool extractLeaf(
        tinyxml2::XMLElement* node,
        std::shared_ptr<IYangElement> parentElement);
    bool extractListLeaf(
        tinyxml2::XMLElement* node,
        std::shared_ptr<IYangElement> parentElement);
    bool extractEntry(
        tinyxml2::XMLElement* node,
